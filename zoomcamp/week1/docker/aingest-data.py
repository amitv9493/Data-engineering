...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Ingest data from a CSV file into a PostgreSQL database")

    parser.add_argument("--user", help="user name for the PostgreSQL database", type=str)
    parser.add_argument("--password", help="password for the PostgreSQL database", type=str)
    parser.add_argument("--host", help="host for the PostgreSQL database", type=str)
    parser.add_argument("--db", help="database name for the PostgreSQL database", type=str)
    parser.add_argument("--port", help="port number for the PostgreSQL database", type=int)
    parser.add_argument("--table_name", help="table name for the PostgreSQL database", type=str)
